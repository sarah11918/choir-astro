...
const Join = () => {
  return (
    <Layout>
      ...
      <p>Rehearsals are held weekly, Tuesday nights from 7:00 p.m. to 9:00 p.m. at Three Oaks High School in Summerside. These rehearsals, as well as any change to our normal schedule, can be viewed on our <Link to="/calendar/">calendar page</Link> or by subscribing to the <Link to="https://calendar.google.com/calendar/u/0/embed?src=sumchoir@gmail.com&ctz=America/Halifax">Summerside Choir’s Google Calendar</Link>.</p>
      <p>Please show up early enough that you are in your seat and ready to start warm-ups at 7:00 p.m. sharp!</p>
